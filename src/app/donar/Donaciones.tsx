...
export default function DonatePage() {
  ...
  return (
    ...
    <div className="p-4 md:p-6 flex flex-col md:flex-row items-center justify-center gap-6">
        ...
        {/* Parte derecha con el mural de donaciones */}
        <section className="w-full md:w-1/2 ml-6 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200 shadow-sm">
            ...
            {mockDonaciones.map((d: any, idx: number) => (
              ...
              >
                ...
                <div className="text-right">
                  <div className="text-green-700 font-medium">S/ {d.monto}</div>
                </div>
              </div>
            ))}
          </div>
